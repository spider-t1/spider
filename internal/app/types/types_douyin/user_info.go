...
type DouyinUserInfoResp struct {
	...
	User       struct {
		...
		ProfileComponentDisabled []string `json:"profile_component_disabled"`
		ProfileMobParams         []struct {
			EventKey  string `json:"event_key"`
			MobParams string `json:"mob_params"`
		} `json:"profile_mob_params"`
		ProfileRecordParams string `json:"profile_record_params"`
		ProfileShow         struct {
		...
		StoryRing              struct {
			StoryRings interface{} `json:"story_rings"`
