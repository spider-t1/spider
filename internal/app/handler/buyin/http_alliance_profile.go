...
// AllianceProfileHandler 达人档案页信息
// @Summary 获取达人档案页信息
// @Description 通过 uid 与鉴权参数获取达人档案页信息
// @Tags buyin
// @Produce json
...
// @Success 200 {object} buyin_logic.AllianceProfileData
// @Router /api/buyin/author/profile [get]
func AllianceProfileHandler(c *gin.Context) {
    var (
        err error
        req types_buyin.AllianceProfileReq
        res = &buyin_logic.AllianceProfileData{}
    )
    ...
    res, err = client.AllianceProfile(&buyin_logic.AllianceProfileParams{UID: req.UID, WorksType: req.WorksType})
    if err != nil { return }
}